...
public class OrderedComparator<String> implements Comparator<String>  {
	...
	public int compare(final String o1, final String o2) {
        return Double.compare(Double.parseDouble((java.lang.String) o1), Double.parseDouble((java.lang.String) o2));
    }
