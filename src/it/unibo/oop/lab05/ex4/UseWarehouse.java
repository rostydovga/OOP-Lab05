...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
         ...
         */
        final Product p1 = new ComparableProduct("Albicocche", 180.52);
        final Product p2 = new ComparableProduct("Mele", 75.3);
        final Product p3 = new ComparableProduct("Pere", 54.6);
